                    ...
                    <div class="col-xs-8 table-responsive">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                               <h4>สัญญาเช่า : </b><?= $model->leasing_id; ?> หมายเลขห้อง : <?= \app\models\Rooms::getRoomname($room) ?></h4>
                                <b>ผู้เช่า 1 : </b><?= $cus_name ?><br>
                                <b>ผู้เช่า 2 : </b><?= $cus_name2 ?>
                            </div>
                            <!--
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <h3 style="text-align: right;"><b>ห้อง : </b><?php // \app\models\Rooms::showName($room); ?></h3>
                            </div>
                            -->
