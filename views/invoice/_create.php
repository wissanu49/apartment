                    ...
                    <div class="col-xs-12 table-responsive">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <h4>หมายเลขห้อง : <?= \app\models\Rooms::getRoomname($room) ?></h4>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 20%;">
                                                    <div class="form-group">
                                                        ...
                                                        <?php // Html::textInput('', '', ['id' => 'invoice-electric_unit_total', 'class' => 'form-control', 'readonly' => 'readonly']) ?>
                                                    </div>
                                                </td>
                                                -->
                                            </tr>
                                    ...
                                    <td>
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 20%;">
                                                    <div class="form-group">
                                                        <?php // Html::textInput('', '', ['id' => 'invoice-water_unit_total', 'class' => 'form-control', 'readonly' => 'readonly']) ?>
                                                    </div>
                                                </td>
                                                -->
                                            </tr>    
