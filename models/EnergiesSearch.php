...
/**
 * EnergiesSearch represents the model behind the search form of `app\models\Energies`.
 */
class EnergiesSearch extends Energies
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['users_id'], 'integer'],
            [['id', 'water_unit', 'electric_unit', 'rooms_id'], 'double'],
